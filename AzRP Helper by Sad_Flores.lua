...
local new_tab_active = imgui.ImBool(load_settings.settings.new_tab_active)
local new_chat_active = imgui.ImBool(load_settings.settings.new_chat_active)
local new_dialog_active = imgui.ImBool(load_settings.settings.new_dialog_active)
